...
\begin{frame}[fragile]{2.1 Замыкание лямбды: Шаг 1. Вызов \alert{f}}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of repl] (f1-1) {\mintinline{scheme}{ (f 4) }}
...
\begin{frame}[fragile]{2.1 Замыкание лямбды: Шаг 2. Тело \alert{f}: подготовка вызова \alert{g}}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of repl] (f1-1) {\mintinline{scheme}{ (f 4) }}
                edge [<-, thick, blue!70!black] (repl);
            \node[env-node=1, above=of repl, right=of f1-1] (stack1) { x $\mid$ 4 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (p1) {\mintinline{scheme}{ (+ (g (lambda (y) (* x y)) 3) }}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (p1) {\mintinline{scheme}{ (+ (g (lambda (y) (* x y)) 3) }}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black] (stack1);
            \node[box, above=of p1] (g1) {\mintinline{scheme}{  (g (lambda (y) (* x y)) }}
...
\begin{frame}[fragile]{2.1 Замыкание лямбды: Шаг 4. Вызов \alert{g}: новый фрейм}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of repl] (f1-1) {\mintinline{scheme}{ (f 4) }}
                edge [<-, thick, blue!70!black] (repl);
            \node[env-node=1, above=of repl, right=1cm of f1-1] (stack1) { x $\mid$ 4 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (p1) {\mintinline{scheme}{ (+ (g (lambda (y) (* x y)) 3) }}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black] (stack1);
            \node[box, above=1.3cm of p1, xshift=-0.5cm] (g1) {\mintinline{scheme}{ (g (lambda (y) (* x y)) }}
                edge [<-, thick, blue!70!black, bend right=25] (p1);
            \node[env-node=1, right=of g1, below=0.7cm, xshift=0.6cm] (stack2) { h $\mid$ \mintinline{scheme}{ (lambda (y) (* x y)) } }
                edge [dashed, thick, blue!70!black, bend right=20] (g1)
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (p1) {\mintinline{scheme}{ (+ (g (lambda (y) (* x y)) 3) }}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black] (stack1);
            \node[box, above=1.4cm of p1, xshift=-0.7cm] (g1) {\mintinline{scheme}{ (g (lambda (y) (* x y)) }}
                edge [<-, thick, blue!70!black, bend right=35] (p1);
            \node[env-node=1, right=of g1, below=0.65cm, xshift=0.6cm] (stack2) { h $\mid$ \mintinline{scheme}{ (lambda (y) (* x y)) } }
                edge [dashed, thick, blue!70!black, bend right=20] (g1)
                edge [dashed, thick, blue!70!black, bend left=45] (stack1);
            \node[box, above=of g1] (h1) {\mintinline{scheme}{ (h (h 7)) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack2)
...
\begin{frame}[fragile]{2.1 Замыкание лямбды: Шаг 6. Первый вызов \alert{h}: аргумент 7}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of g1] (h1) {\mintinline{scheme}{ (h (h 7)) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack2)
                edge [<-, thick, blue!70!black] (g1);
            \node[box, above=of h1] (h2) {\mintinline{scheme}{ (h 7) }}
                edge [dashed, thick, blue!70!black, bend left=35] (stack2)
...
\begin{frame}[fragile]{2.1 Замыкание лямбды: Шаг 7. Применение лямбды: фрейм \alert{y=7}}
    \begin{columns}[c]
        ...
        из внешнего окружения \mintinline{scheme}{f}
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of g1] (h1) {\mintinline{scheme}{ (h (h 7)) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack2)
                edge [<-, thick, blue!70!black] (g1);
            \node[box, above=of h1] (h2) {\mintinline{scheme}{ ((lambda (y) (* x y)) 7) }}
                edge [dashed, thick, blue!70!black, bend left=35] (stack2)
                edge [<-, thick, blue!70!black] (h1);
            \node[env-node=1, above=of repl, right=1cm of h2] (stack3) { y $\mid$ 7 }
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of g1] (h1) {\mintinline{scheme}{ (h (h 7)) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack2)
                edge [<-, thick, blue!70!black] (g1);
            \node[box, above=of h1] (h2) {\mintinline{scheme}{ 28 }}
                edge [dashed, thick, blue!70!black, bend left=35] (stack2)
                edge [->, thick, blue!70!black, bend right=30] (h1)
                edge [<-, thick, blue!70!black] (h1);
            \node[env-node=1, above=of repl, right=1cm of h2] (stack3) { y $\mid$ 7 }
                edge [dashed, thick, blue!70!black] (h2);
        \end{tikzpicture}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of g1, below=0.65cm, xshift=0.6cm] (stack2) { h $\mid$ \mintinline{scheme}{ (lambda (y) (* x y)) } }
                edge [dashed, thick, blue!70!black, bend right=20] (g1)
                edge [dashed, thick, blue!70!black, bend left=45] (stack1);
            \node[box, above=of g1] (h1) {\mintinline{scheme}{ (h 28) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack2)
                edge [<-, thick, blue!70!black] (g1);
        \end{tikzpicture}
    \end{columns}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of g1, below=0.65cm, xshift=0.6cm] (stack2) { h $\mid$ \mintinline{scheme}{ (lambda (y) (* x y)) } }
                edge [dashed, thick, blue!70!black, bend right=20] (g1)
                edge [dashed, thick, blue!70!black, bend left=45] (stack1);
            \node[box, above=of g1] (h1) {\mintinline{scheme}{ ((lambda (y) (* x y)) 28) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack2)
                edge [<-, thick, blue!70!black] (g1);
            \node[env-node=1, above=of g1, right=1cm of h1] (stack3) { y $\mid$ 28 }
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of g1, below=0.65cm, xshift=0.6cm] (stack2) { h $\mid$ \mintinline{scheme}{ (lambda (y) (* x y)) } }
                edge [dashed, thick, blue!70!black, bend right=20] (g1)
                edge [dashed, thick, blue!70!black, bend left=45] (stack1);
            \node[box, above=of g1] (h1) {\mintinline{scheme}{ 112 }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack2)
                edge [->, thick, blue!70!black, bend right=30] (g1)
                edge [<-, thick, blue!70!black] (g1);
            \node[env-node=1, above=of g1, right=1cm of h1] (stack3) { y $\mid$ 28 }
                edge [dashed, thick, blue!70!black] (h1);
        \end{tikzpicture}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (p1) {\mintinline{scheme}{ (+ (g (lambda (y) (* x y)) 3) }}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black] (stack1);
            \node[box, above=1.3cm of p1, xshift=-1cm] (g1) {112}
                edge [->, thick, blue!70!black, bend right=30] (p1)
                edge [<-, thick, blue!70!black] (p1);
            \node[env-node=1, right=of g1, below=0.7cm, xshift=1.8cm] (stack2) { h $\mid$ \mintinline{scheme}{ (lambda (y) (* x y)) } }
                edge [dashed, thick, blue!70!black, bend right=20] (g1)
                edge [dashed, thick, blue!70!black, bend left=30] (stack1);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{2.1 Замыкание лямбды: Шаг 13. Финальное +3 в \alert{f}}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, above=of repl, right=of f1-1] (stack1) { x $\mid$ 4 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (p1) {\mintinline{scheme}{ (+ 112 3) }}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black] (stack1);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{2.1 Замыкание лямбды: Шаг 14. Результат \alert{f}: 115}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, above=of repl, right=of f1-1] (stack1) { x $\mid$ 4 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (p1) {\mintinline{scheme}{ 115 }}
                edge [<-, thick, blue!70!black] (f1-1)
...
\begin{frame}[fragile]{2.1 Замыкание лямбды: Шаг 15. Завершение вычисления}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box] (repl) {\alert{REPL}};
            \node[box, above=of repl] (f1-1) {\mintinline{scheme}{ 115 }}
                edge [<-, thick, blue!70!black] (repl);
        \end{tikzpicture}
    \end{columns}
\end{frame}
