...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 1. Начальный вызов}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of repl] (f1-1) {\mintinline{scheme}{(f1 n)}}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 2. Вызов \alert{if}}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box] (repl) {\alert{REPL}};
            \node[box, above=of repl] (f1-1) {\mintinline{scheme}{(f1 3)}}
                edge [<-, thick, blue!70!black] (repl);
            \node[env-node=1, right=of f1-1] (stack1) { n $\mid$ 3 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (if-1) {\mintinline{scheme}{(if (= n 0))}}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 3. Вычисление предиката}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (if-1) {\mintinline{scheme}{(if (= n 0))}}
                edge [<-, thick, blue!70!black] (f1-1);
            \node[box, above=of if-1] (eq-1) {\mintinline{scheme}{(= n 0)}}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 4. Предикат ложен}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (if-1) {\mintinline{scheme}{(if (= n 0))}}
                edge [<-, thick, blue!70!black] (f1-1);
            \node[box, above=of if-1] (eq-1) {\mintinline{scheme}{#f}}
                edge [<-, thick, blue!70!black] (if-1)
                edge [->, thick, blue!70!black, bend right=30] (if-1);
        \end{tikzpicture}
    \end{columns}
\end{frame}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 5. Выбор else-ветки}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of f1-1] (stack1) { n $\mid$ 3 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (if-1) {\mintinline{scheme}{(if #f)}}
                edge [<-, thick, blue!70!black] (f1-1);
        \end{tikzpicture}
    \end{columns}
\end{frame}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 6. Вычисление тела рекурсии}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of f1-1] (stack1) { n $\mid$ 3 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{(* (f1 (- n 1)) n)}}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black, bend left=10] (stack1);
        \end{tikzpicture}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{(* (f1 (- n 1)) n)}}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black, bend left=10] (stack1);
            \node[box, above=of mul-1] (f1-2) {\mintinline{scheme}{(f1 (- n 1))}}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 8. Вычисление аргумента}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of mul-1] (f1-2) {\mintinline{scheme}{(f1 (- n 1))}}
                edge [<-, thick, blue!70!black] (mul-1);
            \node[box, above=of f1-2] (sub-2) {\mintinline{scheme}{(- n 1)}}
                edge [<-, thick, blue!70!black] (f1-2)
                edge [dashed, thick, blue!70!black, bend left=40] (stack1);
        \end{tikzpicture}
    \end{columns}
\end{frame}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 9. Вычисление аргумента}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of mul-1] (f1-2) {\mintinline{scheme}{(f1 (- n 1))}}
                edge [<-, thick, blue!70!black] (mul-1);
            \node[box, above=of f1-2] (sub-2) {\mintinline{scheme}{2}}
                edge [<-, thick, blue!70!black] (f1-2)
                edge [dashed, thick, blue!70!black, bend left=40] (stack1)
                edge [->, thick, blue!70!black, bend right=30] (f1-2);
        \end{tikzpicture}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{(* (f1 (- n 1)) n)}}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black, bend left=10] (stack1);
            \node[box, above=of mul-1] (f1-2) {\mintinline{scheme}{(f1 2)}}
                edge [<-, thick, blue!70!black] (mul-1);
        \end{tikzpicture}
    \end{columns}
\end{frame}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 12. Максимальная глубина стека}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of f1-2] (stack2) { n $\mid$ 2 }
                edge [dashed, thick, blue!70!black] (f1-2);
            \node[box, above=of f1-2] (mul-2) {\mintinline{scheme}{(* (f1 (- n 1)) n)}}
                edge [<-, thick, blue!70!black] (f1-2)
                edge [dashed, thick, blue!70!black, bend left=10] (stack2);
            \node[box, above=of mul-2] (f1-3) {\mintinline{scheme}{(f1 1)}}
                edge [<-, thick, blue!70!black] (mul-2);
            \node[env-node=1, right=of f1-3] (stack3) { n $\mid$ 1 }
                edge [dashed, thick, blue!70!black] (f1-3);
            \node[box, above=of f1-3] (mul-3) {\mintinline{scheme}{(* (f1 (- n 1)) n)}}
                edge [<-, thick, blue!70!black] (f1-3)
                edge [dashed, thick, blue!70!black, bend left=10] (stack3);
            \node[box, above=of mul-3] (f1-4) {\mintinline{scheme}{(f1 0)}}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-3] (mul-3) {\mintinline{scheme}{(* (f1 (- n 1)) n)}}
                edge [<-, thick, blue!70!black] (f1-3)
                edge [dashed, thick, blue!70!black, bend left=10] (stack3);
            \node[box, above=of mul-3] (f1-4) {\mintinline{scheme}{1}}
                edge [<-, thick, blue!70!black] (mul-3)
                edge [->, thick, blue!70!black, bend right=40] (mul-3);
            \node[env-node=1, right=of f1-4] (stack3) { n $\mid$ 0 }
                edge [dashed, thick, blue!70!black] (f1-4);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 14. Первое умножение в сворачивании}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of f1-3] (stack3) { n $\mid$ 1 }
                edge [dashed, thick, blue!70!black] (f1-3);
            \node[box, above=of f1-3] (mul-3) {\mintinline{scheme}{(* 1 1)}}
                edge [<-, thick, blue!70!black] (f1-3)
                edge [dashed, thick, blue!70!black, bend left=10] (stack3);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 15. Передача результата вверх}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of f1-3] (stack3) { n $\mid$ 1 }
                edge [dashed, thick, blue!70!black] (f1-3);
            \node[box, above=of f1-3] (mul-3) {\mintinline{scheme}{1}}
                edge [<-, thick, blue!70!black] (f1-3)
                edge [->, thick, blue!70!black, bend right=30] (f1-3)
                edge [dashed, thick, blue!70!black, bend left=10] (stack3);
        \end{tikzpicture}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-2] (mul-2) {\mintinline{scheme}{(* (f1 (- n 1)) n)}}
                edge [<-, thick, blue!70!black] (f1-2)
                edge [dashed, thick, blue!70!black, bend left=10] (stack2);
            \node[box, above=of mul-2] (f1-3) {\mintinline{scheme}{1}}
                edge [<-, thick, blue!70!black] (mul-2)
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 17. Умножение на втором уровне}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of f1-2] (stack2) { n $\mid$ 2 }
                edge [dashed, thick, blue!70!black] (f1-2);
            \node[box, above=of f1-2] (mul-2) {\mintinline{scheme}{(* 1 2)}}
                edge [<-, thick, blue!70!black] (f1-2)
                edge [dashed, thick, blue!70!black, bend left=10] (stack2);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 18. Завершение второго уровня}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of f1-2] (stack2) { n $\mid$ 2 }
                edge [dashed, thick, blue!70!black] (f1-2);
            \node[box, above=of f1-2] (mul-2) {\mintinline{scheme}{2}}
                edge [<-, thick, blue!70!black] (f1-2)
                edge [->, thick, blue!70!black, bend right=30] (f1-2)
                edge [dashed, thick, blue!70!black, bend left=10] (stack2);
        \end{tikzpicture}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{(* (f1 (- n 1)) n)}}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black, bend left=10] (stack1);
            \node[box, above=of mul-1] (f1-2) {\mintinline{scheme}{2}}
                edge [<-, thick, blue!70!black] (mul-1)
...
\begin{frame}[fragile]{1.1 Обычная рекурсия: Шаг 20. Умножение на 4 уровне}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=1, right=of f1-1] (stack1) { n $\mid$ 3 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{(* 2 3)}}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [dashed, thick, blue!70!black, bend left=10] (stack1);
        \end{tikzpicture}
    \end{columns}
