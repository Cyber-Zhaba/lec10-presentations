...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 1. Начальный вызов}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of repl] (f2-1) {\mintinline{scheme}{(f2 3 1)}}
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 2. Проверка базового случая}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box] (repl) {\alert{REPL}};
            \node[box, above=of repl] (f1-1) {\mintinline{scheme}{(f2 3 1)}}
                edge [<-, thick, blue!70!black] (repl);
            \node[env-node=2, right=of f1-1] (stack1) { n $\mid$ 3 \nodepart{two} acc $\mid$ 1 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (if (= n 0)) }}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (if (= n 0)) }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (f1-1);
            \node[box, above=of mul-1] (eq1) {\mintinline{scheme}{ (= n 0) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack1)
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (if (= n 0)) }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (f1-1);
            \node[box, above=of mul-1] (eq1) {\mintinline{scheme}{ #f }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack1)
                edge [<-, thick, blue!70!black] (mul-1)
                edge [->, thick, blue!70!black, bend right=30] (mul-1);
        \end{tikzpicture}
    \end{columns}
\end{frame}
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 5. Сведение к хвостовому вызову}
    \begin{columns}[c]
        ...
        \mintinline{scheme}{if} выбирает else-ветку
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=2, right=of f1-1] (stack1) { n $\mid$ 3 \nodepart{two} acc $\mid$ 1 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (if #f) }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (f1-1);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 6. Подготовка аргументов}
    \begin{columns}[c]
        ...
        Форма \mintinline{scheme}{if} полностью свелась к телу рекурсивного
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=2, right=of f1-1] (stack1) { n $\mid$ 3 \nodepart{two} acc $\mid$ 1 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (f2 (- n 1) (* n acc)) }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (f1-1);
        \end{tikzpicture}
    \end{columns}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (f2 (- n 1) (* n acc)) }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (f1-1);
            \node[box, above=1.2cm of mul-1, xshift=3cm] (sub-1) {\mintinline{scheme}{ (- n 1) }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (mul-1);
            \node[box, above=1.2cm of mul-1, left=of sub-1] (mul-2) {\mintinline{scheme}{ (* n acc) }}
                edge [dashed, thick, blue!70!black, bend left=22] (stack1)
                edge [<-, thick, blue!70!black] (mul-1);
        \end{tikzpicture}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (f2 (- n 1) (* n acc)) }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (f1-1);
            \node[box, above=1.2cm of mul-1, xshift=3cm] (sub-1) {\mintinline{scheme}{ 2 }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (mul-1);
            \node[box, above=1.2cm of mul-1, left=of sub-1] (mul-2) {\mintinline{scheme}{ 3 }}
                edge [dashed, thick, blue!70!black, bend left=22] (stack1)
                edge [<-, thick, blue!70!black] (mul-1);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 9. Рекурсивный хвостовой вызов}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[env-node=2, right=1.5cm of f1-1] (stack1) { n $\mid$ 3 \nodepart{two} acc $\mid$ 1 }
                edge [dashed, thick, blue!70!black] (f1-1);
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (f2 2 3) }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (f1-1);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 10. Новый фрейм не создаётся}
    \begin{columns}[c]
        ...
        После оптимизации вместо создания нового фрейма,
        интерпретатор перезаписывает текущий фрейм.

        Фактически это сводит рекурсию к итерации.
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 11. Итерация: обновление фрейма}
    \begin{columns}[c]
        ...
        \mintinline{scheme}{n = 2} и \mintinline{scheme}{acc = 3}
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 12. Ещё одна хвостовая оптимизация}
    \begin{columns}[c]
        ...
        Следующий рекурсивный вызов снова сводится к итерации
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (f2 2 3) }}
                edge [dashed, thick, blue!70!black] (stack1)
                edge [<-, thick, blue!70!black] (f1-1);
            \node[box, above=of mul-1] (mul-2) {\mintinline{scheme}{ (f2 1 6) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack1)
                edge [<-, thick, blue!70!black] (mul-1);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 13. Третья итерация}
    \begin{columns}[c]
        ...
        Стек по-прежнему перезаписывается в ходе итераций
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of mul-1] (mul-2) {\mintinline{scheme}{ (f2 1 6) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack1)
                edge [<-, thick, blue!70!black] (mul-1);
            \node[box, above=of mul-2] (mul-3) {\mintinline{scheme}{ (f2 0 6) }}
                edge [dashed, thick, blue!70!black, bend left=30] (stack1)
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 16. Возврат аккумулятора}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of mul-1] (mul-2) {\mintinline{scheme}{ (f2 1 6) }}
                edge [<-, thick, blue!70!black] (mul-1);
            \node[box, above=of mul-2] (mul-3) {\mintinline{scheme}{ (acc) }}
                edge [<-, thick, blue!70!black] (mul-2)
                edge [dashed, thick, blue!70!black, bend left=30] (stack1);
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 17. Подъём результата}
    \begin{columns}[c]
        ...
        (\mintinline{scheme}{n} $\to 1 \to 2 \to 3$),
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of mul-1] (mul-2) {\mintinline{scheme}{ (f2 1 6) }}
                edge [<-, thick, blue!70!black] (mul-1);
            \node[box, above=of mul-2] (mul-3) {\mintinline{scheme}{ 6 }}
                edge [<-, thick, blue!70!black] (mul-2)
                edge [->, thick, blue!70!black, bend right=30] (mul-2)
                edge [dashed, thick, blue!70!black, bend left=30] (stack1);
        \end{tikzpicture}
    \end{columns}
\end{frame}
...
\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 18. Подъём результата}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ (f2 2 3) }}
                edge [<-, thick, blue!70!black] (f1-1);
            \node[box, above=of mul-1] (mul-2) {\mintinline{scheme}{ 6 }}
                edge [<-, thick, blue!70!black] (mul-1)
                edge [->, thick, blue!70!black, bend right=30] (mul-1);
        \end{tikzpicture}
    \end{columns}
    ...
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, above=of repl] (f1-1) {\mintinline{scheme}{(f2 3 1)}}
                edge [<-, thick, blue!70!black] (repl);
            \node[env-node=2, right=1.5cm of f1-1] (stack1) { n $\mid$ 0 \nodepart{two} acc $\mid$ 6 };
            \node[box, above=of f1-1] (mul-1) {\mintinline{scheme}{ 6 }}
                edge [<-, thick, blue!70!black] (f1-1)
                edge [->, thick, blue!70!black, bend right=30] (f1-1);
        \end{tikzpicture}
    \end{columns}
\end{frame}


\begin{frame}[fragile]{1.2 Хвостовая рекурсия: Шаг 20. Всё завершено — результат в REPL}
    \begin{columns}[c]
        ...
        \begin{tikzpicture}[
            ...
            \node[box] (repl) {\alert{REPL}};
            \node[box, above=of repl] (f1-1) {\mintinline{scheme}{ 6 }}
                edge [<-, thick, blue!70!black] (repl);
        \end{tikzpicture}
    \end{columns}
\end{frame}
